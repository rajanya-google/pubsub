...
public class Prober {
  ...
  static class Builder {
    ...
    boolean exactlyOnceDelivery = false;
    ...
    public Builder setExactlyOnceDelivery(boolean exactlyOnceDelivery) {
  ...
  Prober(Builder builder) {
    this.exactlyOnceDelivery = builder.exactlyOnceDelivery;
